...
# Enable Multi-Agent Mode (Set to 'True' or 'False')
export MULTI_AGENT_MODE=True # True, False
...
if [ "$MULTI_AGENT_MODE" = "False" ]; then
  ...
  alias joy='ros2 launch joy joy-launch.py'
  alias lidar='ros2 launch urg_node urg_node_multi_agent_launch.py'
  alias vesc='ros2 launch vesc vesc_multi_agent.launch.py'
  alias imu='ros2 launch microstrain_inertial_examples gx5_25_multi_agent_launch.py'
  alias cartomapping='ros2 launch cartographer_easystart mapping_2d_launch.py'
  alias cartolocal='ros2 launch cartographer_easystart localization_2d_multi_agent_launch.py'
fi
